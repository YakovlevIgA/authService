...
const (
	...
	AuthService_DropPass_FullMethodName  = "/auth.AuthService/DropPass"
...
type AuthServiceClient interface {
	...
	DropPass(ctx context.Context, in *DropPassRequest, opts ...grpc.CallOption) (*DropPassResponse, error)
...
func (c *authServiceClient) DropPass(ctx context.Context, in *DropPassRequest, opts ...grpc.CallOption) (*DropPassResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DropPassResponse)
	err := c.cc.Invoke(ctx, AuthService_DropPass_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	DropPass(context.Context, *DropPassRequest) (*DropPassResponse, error)
...
func (UnimplementedAuthServiceServer) DropPass(context.Context, *DropPassRequest) (*DropPassResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DropPass not implemented")
}
...
func _AuthService_DropPass_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DropPassRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).DropPass(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_DropPass_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).DropPass(ctx, req.(*DropPassRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DropPass",
			Handler:    _AuthService_DropPass_Handler,
		},
		{
			MethodName: "Validate",
	...
	Metadata: "protos/proto/home.proto",
}
